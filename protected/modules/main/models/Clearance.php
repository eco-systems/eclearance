...
class Clearance extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('station_id, applicant_id, clearance_no, purpose, or_number, investigator_id, officer_id, findings, residentcertnumber, amount, datefiled', 'required'),
			array('station_id, applicant_id, investigator_id, officer_id, datefiled', 'numerical', 'integerOnly'=>true),
			array('clearance_no, purpose, or_number, findings, residentcertnumber', 'length', 'max'=>200),
			array('amount', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, station_id, applicant_id, clearance_no, purpose, or_number, investigator_id, officer_id, findings, residentcertnumber, amount, datefiled', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('clearance_no',$this->clearance_no,true);
